...
import { getCompleteMovieDetails, getMoviesByCategory } from "@/server/lib/actions/getMoviesData";
  ...
  return (
    <main className="flex flex-col gap-[32px]">
      ...
      <Container >
        ...
        <MoviesCarousel className="pt-10" category="Related films" items={relatedFilms}/>
      </Container>
    </main>
  );
}
